...
export default defineSchema({
  ...
  oauth_connect_states: defineTable({
    id: v.string(),
    org_id: v.string(),
    initiating_user_id: v.optional(v.string()),
    provider: providerValidator,
  ...
  automation_runs: defineTable({
    ...
    outcome_success: v.optional(v.union(v.boolean(), v.null())),
    outcome_summary: v.optional(v.union(v.string(), v.null())),
    ...
    trace_id: v.optional(v.union(v.string(), v.null())),
    trace_group_id: v.optional(v.union(v.string(), v.null())),
    trace_workflow_name: v.optional(v.union(v.string(), v.null())),
    trace_last_response_id: v.optional(v.union(v.string(), v.null())),
    trace_export_status: v.optional(v.union(automationRunTraceExportStatusValidator, v.null())),
    trace_error_message: v.optional(v.union(v.string(), v.null())),
    trace_recorded_at: v.optional(v.union(v.string(), v.null())),
