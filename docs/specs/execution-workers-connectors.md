...
- Desktop helper boundary:
  ...
  - helper callback ingest (`/api/automations/openai/helper/callback`) now runs in the Start-owned web runtime; the helper never receives long-lived Keppo credentials.
