...
- Pausing an automation is authoritative for already-started work: the control plane drains all currently active runs in bounded batches until none remain active for that automation.
