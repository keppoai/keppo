...
- Root-path `/mcp/*` and `/internal/*` ingress enters the Start runtime directly in hosted/dev builds. Unknown protocol-like paths now fail closed with structured `404 route_not_found` responses instead of forwarding into a second runtime.
