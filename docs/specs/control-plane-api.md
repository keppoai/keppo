...
| Area                       | Routes                                                                                                                                                                                                                                                  |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ------------------------- |
| Health                     | `GET /api/health`, `GET /api/version`, `GET /api/health/deep`, `GET /api/health/flags`, `GET /api/health/audit-errors`, `GET /api/health/dlq`, `POST /api/health/dlq/:id/replay`, `POST /api/health/dlq/:id/abandon` |
