...
| Workflow               | Role                                                                                                                                                      |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pr-review.yml`        | Runs Claude + Codex reviews, posts summary comments with verdict + recommendation, and applies validated inline review comments for actionable findings. Inline-comment posting is additive and must not block the summary comment that `pr-watcher` reads. |
