...
| Workflow               | Role                                                                                                                                                      |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pr-review.yml`        | Runs Claude + Codex reviews, validates and posts the load-bearing summary comment, and separately validates/posts inline review comments for actionable findings. Inline-comment validation, token minting, and posting are additive and must not block the summary comment that `pr-watcher` reads. |
