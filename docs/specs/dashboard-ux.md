...
- Settings page includes org-level AI key manager:
  ...
  - OpenAI `subscription_token` mode connects via the direct browser-based OAuth flow (`GET /api/automations/openai/connect`) using Keppo-owned PKCE and signed state.
