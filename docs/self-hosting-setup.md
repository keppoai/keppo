...
| `KEPPO_RELEASE_NAME`                                       | build          | `@keppo/web`                      | Source-map release name                                                                                                                                                                                                           |
...
| `KEPPO_AUTOMATION_DISPATCH_URL`                            | convex         | auto                              | URL to `/internal/automations/dispatch`                                                                                                                                                                                           |
| `KEPPO_AUTOMATION_TERMINATE_URL`                           | convex         | auto                              | URL to `/internal/automations/terminate`                                                                                                                                                                                          |
