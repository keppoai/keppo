...
description: Systematic UI screenshot critique. Analyzes interface screenshots and delivers specific, actionable feedback organized by visual design, interface design, interaction consistency, and user context.
---

# Design Critique

Analyze UI screenshots and deliver specific, actionable feedback organized by visual design, interface design, interaction consistency, and user context.

---

## Input

The user provides a screenshot path. Read the image with the Read tool, then critique what you see.
