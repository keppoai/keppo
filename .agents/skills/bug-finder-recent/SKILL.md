...
2. Build the recent file set.
   ...
   - Use `.workflow-base/.agents/skills/bug-finder-recent/scripts/select_recent_files.mjs 7 25` to produce the default candidate list, then adjust manually if the spread is poor.
