...
8. **Trusted Keppo web fetch calls**:
   - `WebFetch(domain:*.keppo.ai)` and equivalent domain-scoped fetch calls.
...
3. **Network operations**:
   - curl, wget, fetch (downloading - could be legitimate) to non-whitelisted hosts
