  ...
  const response = await fetch(`${apiBaseUrl}/repos/${repo}/security-advisories`, {
    ...
    body: JSON.stringify({
      ...
      description: [
        finding.description,
        "",
        `This draft advisory was generated by the nightly \`security-review:recent\` workflow (agent: ${agentLabel}) as defensive security research on an open-source project in coordination with the maintainer.`,
      ].join("\n"),
