...
const apiEnvSchema = z
  .object({
    ...
    OPENAI_OAUTH_REDIRECT_URI: optionalString,
    KEPPO_OAUTH_HELPER_MACOS_URL: optionalString,
    KEPPO_OAUTH_HELPER_WINDOWS_URL: optionalString,
    KEPPO_OAUTH_HELPER_MACOS_FILENAME: optionalString,
    KEPPO_OAUTH_HELPER_WINDOWS_FILENAME: optionalString,
    KEPPO_OAUTH_HELPER_VERSION: optionalString,
    GOOGLE_REDIRECT_URI: optionalString,
    STRIPE_REDIRECT_URI: optionalString,
    GITHUB_REDIRECT_URI: optionalString,
    OPENAI_OAUTH_AUTH_URL: optionalString,
    OPENAI_OAUTH_TOKEN_URL: optionalString,
    KEPPO_OAUTH_HELPER_ARTIFACT_BASE_URL: optionalString,
