...
const toNegativeGoldenExpectation = (mode) => {
...
const withGoldenExpectations = (scenario) => {
  if (scenario.golden) {
    return scenario;
  }
...
const providerActionPackDefinitions = [
  {
    providerId: "google",
    ...
    scenarios: [
      {
        ...
        negativeInput: { subreddit: 123, query: "keppo" },
        expectedSdkCalls: [
          {
...
export const providerActionPacks = providerActionPackDefinitions.map((pack) => {
  return {
    ...pack,
